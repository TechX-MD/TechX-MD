...
if (!global.botData.statusSettings) {
    global.botData.statusSettings = {};
}
...
const ownerNumbers = Array.isArray(global.ownerNumber)
    ? global.ownerNumber
    : [global.ownerNumber];
...
m.isOwner = ownerNumbers.some(num =>
    senderNumber === String(num).replace(/[^0-9]/g, "")
);
